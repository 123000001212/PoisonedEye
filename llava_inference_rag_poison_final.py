...
parser.add_argument('--imagenet1k_path', type=str, default="/home/data/imagenet-1k/data", help='path to imagenet1k dataset')
...
img_database = Database(database_path='siglip_mbeir_webqa_task2_cand_pool.bin',
                              encode_model_path='/home/data/LLM/siglip-so400m-patch14-384',
                              device=device)
