...
parser.add_argument('--model_path', type=str, default='/home/data/LLM/siglip-so400m-patch14-384', help='Model path to encode texts and images')
parser.add_argument('--beir_path', type=str, default='/home/data/M-BEIR', help='Path to beir dataset')
